    ...
    return (
      <View style={styles.container}>
        <View style={[styles.item,{right:25}]}>
          ...
          <Text style={[styles.text,{color:Colors.pink}]}>{item.text3}</Text>
        </View>
        <Text style={{fontSize:50,color:Colors.pink,marginTop:30,fontWeight:'bold'}}>{item.text4}</Text>
        <View>
          <View style={[styles.item,{left:25}]}>
            ...
            <Text  style={[styles.text,{color:Colors.pink}]}>{item.text6}</Text>
          </View>
        </View>
      </View>
    );
